...
const App = () => {
    ...
    const debouncedSearchDataUpdate = debounce(
        (searchData: ISearchData) => setSearchData(searchData),
        400
    )

    useEffect(() => {
        Api.getTags((tagsFrequencies: Record<string, number>) => {
    ...
    return (
        <div style={{ backgroundColor: 'whitesmoke' }}>
            ...
            <EntrySearch
                tagsFrequencies={frequencies}
                searchDataUpdatedCallback={debouncedSearchDataUpdate}
            />
